...
print("GOLDEN BASELINE CONTRASTIVE MODEL")
...
if __name__ == '__main__':
    for lr, kd_weight, pa_weight,contrastive_weight, dset, iter in itertools.product(lrs, kd_weights, pa_wights,contrastive_weights, dstes, iterations):
        ...
        pth_rst_exp = '/home/dmittal/Desktop/CGCD-main/src/Saved_Models/Initial/G-Baseline_Contrastive/' + args.dataset + '/' # + args.model + '_sp_' + str(args.use_split_modlue) + '_gm_' + str(args.use_GM_clustering) + '_' + args.exp
        ...
        pth_rst_exp = '/home/dmittal/Desktop/CGCD-main/src/Saved_Models/Incremental/G-Baseline_Contrastive/' + args.dataset + '/'
        ...
        for epoch in range(0,args.nb_epochs):  #args.nb_epochs
            ...
            for batch_idx, (x, y, z) in pbar:
                ...
                contrastive_loss = utils_CGCD.contrastive_loss(feats, y, criterion_pa_now.proxies, True)
...
results_df.to_csv('results_G-Baseline_contrastive_{}_test.csv'.format('_'.join(dstes), index=False))